<section class="developer-dashboard-project-overview-content">
	...
	<?php include("partials/dashboard-project-overview-data.php"); ?>
	...
	<article class="block block-fill project-profile">
		...
		<div class="content">
			...
			<div class="data">
				<p class="bold"><span class="highlight">Visable to</span> All users</p>
				<p class="bold"><span class="highlight">Visable in 'All projects'</span> Yes</p>
			</div>
		</div>
	</article>
