...
<section class="page page-developer-dashboard-project-campaign-overview dashboard-page">
	<div class="container">
		<div class="content">
			...
			<div class="row">
				<?php include("partials/dashboard-side-menu-extended.php"); ?>
				...
				<main class="col-lg-9">
					...
					<?php include("partials/developer-dashboard-project-campaign-overview-content.php"); ?>
				</main>
			</div>
...
<script type="text/javascript" src="[[./js/developerdashboardprojectcampaignoverview-*.js]]"></script>
