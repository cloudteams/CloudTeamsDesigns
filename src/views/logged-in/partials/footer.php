		<footer id="footer" class="footer-public">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-4">
						<ul>
							<li><h2 class="header-small public">About us</h2></li>
					...
					<div class="col-sm-4">
						<div class="row">
							<ul class="col-xs-12">
								<li><h2 class="header-small public">Projects</h2></li>
							</ul>
					...
					<div class="col-sm-4">
						<ul class="social-media">
							...
							<li><a href="" alt="twitter"><div class="icon-size-m icon-twitter"></div></a></li>
							<li><a href="" alt="facebook"><div class="icon-size-m icon-facebook"></div></a></li>
						</ul>
					</div>
				</div>
			</div>
