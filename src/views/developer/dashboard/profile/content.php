<section class="user-profile-content">
	...
	<ul class="menu-subpage">
		...
		<li id="link-to-subpage-2" class="link-to-subpage">Personal information</li>
		<li id="link-to-subpage-3" class="link-to-subpage">Addressses</li>
	</ul>
				...
				<article class="block-line large">
					...
					<div class="content form-section">
						...
						<fieldset class="form-group required">
							<label for="first-name" class="header-medium secondary control-label">Primary e-mail address</label>
						...
						<fieldset class="form-group">
							<label for="first-name" class="header-medium secondary control-label">Add e-mail address</label>
				...
				<article class="block-line large">
					<header class="article-header">
						<div class="vertical-align">
							<div class="middle">
								<i class="icon icon-user"></i>
								<h2 class="header-medium secondary">Personal information</h2>
							</div>
							<div class="middle">
							</div>
						</div>
					...
					<div class="content form-section">
						...
						<fieldset class="form-group">
							<label for="first-name" class="header-medium secondary control-label">Title (prefix)</label>
						...
						<fieldset class="form-group">
							<label for="first-name" class="header-medium secondary control-label">Given name</label>
						...
						<fieldset class="form-group">
							<label for="first-name" class="header-medium secondary control-label">Middle name</label>
						...
						<fieldset class="form-group">
							<label for="first-name" class="header-medium secondary control-label">Title (affix)</label>
						...
						<fieldset class="form-group">
							<label for="first-name" class="header-medium secondary control-label">Job title</label>
