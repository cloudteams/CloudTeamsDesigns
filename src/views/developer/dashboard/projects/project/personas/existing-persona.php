		...
		<div class="block block-fill">
			...
			<div class="modal-body">
				...
				<ul class="menu-subpage">
					...
					<li style="display:none;" id="link-to-subpage-3" class="link-to-subpage entire-section">Persona overview</li>
				</ul>
					...
					<section id="subpage-1" class="subpage active">
						<div class="col-md-6">
							...
							<fieldset class="form-group fieldset-upload">
								<div style="margin:auto;width:300px;height:300px;background-image:url('http://placehold.it/500');background-position:center;"></div>
							</fieldset>
