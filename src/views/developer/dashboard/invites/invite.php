	...
	<header class="article-header">
		<div class="vertical-align">
			...
			<div class="middle">
				...
				<p class="article-subtitle">Web design, User experience</p>
			</div>

			<div class="middle">
				<p class="meta thin inline-block"><span>1</span></p>
				<p class="meta thin inline-block">week ago</p>
			</div>
		</div>
	</header>
	<div class="content">
		...
		<div class="buttons">
			...
			<i class="icon icon-size-s icon-close"></i>
				Decline
			</a>
			<a href="#nowhere" class="btn-confirm">
				<i class="icon icon-size-s icon-approved"></i>
				Confirm
			</a>
		</div>
	</div>
